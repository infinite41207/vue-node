  ...
  getStartData(req, res, next) {
    ...
    const columns = [
      ...
      },
      {
        ...
        sequence: 2,
        property: 'vehicle',
        description: 'Samohód i naczepa',
        title: 'Nr samohodu , naczepy',
      ...
      },
      {
        ...
        title: 'Kierowca',
        sqlColumnName: 'disposition."driverId"',
        valueType: 'object',
      ...
      },
      {
        ...
        description: 'Dowód',
        title: 'Dowód',
        sqlColumnName: 'drivers_idcard',
        valueType: 'text',
        action: 'getAllDriversIdCard',
        visible: true,
        filterable: false,
        groupable: false,
        filterDisabled: false,
  ...
  let queryText =
    '\
        SELECT \
            ...
            delivery_notes."driverId" as driver_id, \
            drivers.name as driver_name,\
            drivers."idCard" as driver_idCard, \
        ...
        FROM \
            ...
            left join drivers as drivers \
            ON delivery_notes."driverId" = drivers.id \
