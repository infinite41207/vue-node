...
import CustomerRequestStatuses from '@/dto/CustomerRequestStatuses.json'
import Question from '@/components/common/question'
import { uuid } from 'vue-uuid'

const namespace = 'customerRequestsStatuses'
...
export default {
  ...
  data() {
    return {
      title: this.$t('route.crStatuses'),
      fields: [
        { key: 'name', label: this.$t('table.name'), sortable: true, width: '25%' },
        { key: 'code', label: this.$t('table.code'), sortable: true, width: '20%' },
        { key: 'color', label: this.$t('table.color'), sortable: true },
  ...
  methods: {
    ...
    addNewObject() {
      const viewId = uuid.v4()
      const object = _.cloneDeep(CustomerRequestStatuses)
      object.id = viewId
      object.isNew = true
