...
import { UserRole } from '@/store/types/UserRole'
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'key', label: this.$t('table.key'), sortable: true },
        { key: 'parent.name', label: this.$t('table.parent'), sortable: true },
        { key: 'delete', label: '-' },
      ],
  ...
  methods: {
    ...mapMutations({
      addObjectView: `userRoles/addObjectView`,
      setListViewProperty: `userRoles/setListViewProperty`,
      setFilter: `userRoles/setFilters`,
      setSort: `userRoles/setSort`,
    }),
    ...
    addNewObject() {
      ...
      const object = _.cloneDeep(UserRole)
      object.id = viewId
      object.isNew = true
