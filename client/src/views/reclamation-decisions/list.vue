...
export default {
  ...
  methods: {
    ...
    async initialize() {
      this.itemsData = await this.$store.dispatch('reclamationDecisions/findAll', {})
    ...
    async saveChanges() {
      if (this.currentItem.id !== null) {
        const res = await this.$store.dispatch('reclamationDecisions/updateItem', this.currentItem)
      } else {
        const res = await this.$store.dispatch('reclamationDecisions/addItem', this.currentItem)
      }
      this.initialize()
    ...
    async deleteItem(deleteItem) {
      const res = await this.$store.dispatch('reclamationDecisions/deleteItem', deleteItem)
      this.initialize()
      this.currentItem = { ...this.newItem() }
