        ...
        <b-card>
          <b-row class="mb-2">
            <b-col>
              <b-button-toolbar>
                <b-btn-group>
                  <b-button variant="outline-secondary" size="sm" @click="showHideFilters">
              ...
              >
                ...
                <template v-slot:cell(actions)="data">
                  <div class="table-button-container">
                    ...
                    <a href="javascript:void(0);" class="action-icon ml-1 ri-delete-bin-7-fill text-danger"> </a>
                  </div>
                </template>
              </b-table>
            </b-col>
...
export default {
  ...
  methods: {
    ...mapMutations({
      addObjectView: `discounts/addObjectView`,
      setListViewProperty: `discounts/setListViewProperty`,
      setFilter: `discounts/setFilters`,
      setSort: `discounts/setSort`,
    }),
