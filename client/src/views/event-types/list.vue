...
export default {
  ...
  methods: {
    ...mapMutations({
      addObjectView: `eventTypes/addObjectView`,
      setListViewProperty: `eventTypes/setListViewProperty`,
      setFilter: `eventTypes/setFilters`,
      setSort: `eventTypes/setSort`,
    }),
    ...
    async updateList() {
      ...
      await this.$store.dispatch(`eventTypes/findAll`, filterStr)
    },
    ...
    async saveChanges() {
      if (this.currentItem.id !== null) {
        const res = await this.$store.dispatch('eventTypes/update', this.currentItem)
      } else {
        const res = await this.$store.dispatch('eventTypes/create', this.currentItem)
      }
      this.initialize()
    ...
    async deleteItem(deleteItem) {
      const res = await this.$store.dispatch('eventTypes/delete', deleteItem)
      this.initialize()
      this.currentItem = { ...this.newItem() }
