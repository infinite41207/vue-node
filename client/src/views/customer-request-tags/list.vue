...
import CustomerRequestTags from '@/dto/CustomerRequestTags.json'
import Question from '@/components/common/question'
import { uuid } from 'vue-uuid'

const namespace = 'customerRequestsTags'
...
export default {
  ...
  methods: {
    ...
    addNewObject() {
      const viewId = uuid.v4()
      const object = _.cloneDeep(CustomerRequestTags)
      object.id = viewId
      object.isNew = true
