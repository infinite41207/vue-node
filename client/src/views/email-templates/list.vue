        ...
        <b-card>
          <b-row class="mb-2">
            <b-col>
              <b-button-toolbar>
                <b-button-group>
                  <b-button id="add-btn" variant="success" size="sm" :disabled="readOnly" @click="addNewObject">
...
import EmailTemplate from '../../dto/EmailTemplate.json'
...
export default {
  ...
  methods: {
    ...
    addNewObject() {
      const viewId = uuid.v4()
      const newObject = _.cloneDeep(EmailTemplate)
      newObject.id = viewId
      newObject.isNew = true
