...
import BasicObject from '@/dto/Vehicle.json'
...
export const actions = {
  ...
  async getListFields() {
    return [
      { key: 'name', label: 'table.name', sortable: true, width: '30%' },
      { key: 'code', label: 'table.code', sortable: true, width: '20%' },
      { key: 'type', label: 'table.type', sortable: true, width: '20%', formatter: { dataType: 'enum', key: 'transportTypes' } },
      { key: 'tare', label: 'table.declaredTare', sortable: true },
      { key: 'loadCapacity', label: 'table.loadCapacity', sortable: true },
      { key: 'carBrand', label: 'table.carBrand', sortable: true },
