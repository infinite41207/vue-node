...
import BasicObject from '@/dto/ContactPerson.json'
const apiUrl = 'contact_persons'
...
export const actions = {
  ...
  async getListFields() {
    return [
      ...
      { key: 'birthDate', label: 'table.dateOfBirth', sortable: true, formatter: { dataType: 'date', format: 'DD.MM.YYYY' } },
      { key: 'phone', label: 'table.phone', sortable: true },
      { key: 'email', label: 'table.email', sortable: true },
      { key: 'address', label: 'table.address', sortable: true },
      { key: 'counterparty.name', label: 'table.contractor', sortable: true },
      { key: 'standing.description', label: 'table.station', sortable: true },
      { key: 'sex', label: 'table.sex', sortable: true },
      { key: 'delete', label: 'table.actions', sortable: true, width: '3%' },
    ]
  },
