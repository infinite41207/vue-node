...
import BasicObject from '@/dto/Driver.json'
...
export const actions = {
  ...
  async getListFields() {
    return [
      ...
      { key: 'code', label: 'table.code', sortable: true, width: '15%' },
      { key: 'idCard', label: 'table.idCard', sortable: true, width: '15%' },
      { key: 'attentionCount', label: 'table.attentionCount', sortable: true },
