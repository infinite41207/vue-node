...
import BasicObject from '@/dto/DispositionStatus.json'
const apiUrl = 'disposition_statuses'
...
export const actions = {
  ...
  async getListFields() {
    return [
      ...
      { key: 'key', label: 'table.key', sortable: true },
      { key: 'color', label: 'table.color', sortable: true },
