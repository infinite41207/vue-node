...
import BasicObject from '@/dto/VendorAndCustomer.json'
...
export const actions = {
  ...
  async getListFields() {
    return [
      { key: 'name', label: 'table.name', sortable: true, width: '20%' },
      { key: 'code', label: 'table.code', sortable: true },
      { key: 'isCustomer', label: 'table.customer', sortable: true, formatter: { dataType: 'boolean' } },
      { key: 'isVendor', label: 'table.vendor', sortable: true, formatter: { dataType: 'boolean' } },
      { key: 'isForwarder', label: 'table.forwarder', sortable: true, formatter: { dataType: 'boolean' } },
