...
import BasicObject from '@/dto/Country.json'
...
export const actions = {
  ...
  async getListFields() {
    return [
      ...
      { key: 'alphaCode2', label: 'table.alphaCode2', sortable: true, width: '10%' },
      { key: 'alphaCode3', label: 'table.alphaCode3', sortable: true, width: '10%' },
